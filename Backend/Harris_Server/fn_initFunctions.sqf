...
if (!isMultiplayer || isServer) then {
	...
	Misc_Function_List = ["keyHandler","hideLocally","setFaceGlobal","weaponHolster","playerSurrender","actionSyncMP", "dropHandgun", "hudLoop"];
	...
	Economy_Function_List = ["modifyLicense","openShop","loadShopItems"];
