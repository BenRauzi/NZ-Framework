...
if (!isMultiplayer || isServer) then {
	...
	Misc_Function_List = ["keyHandler","hideLocally","setFaceGlobal","weaponHolster","playerSurrender","actionSyncMP", "dropHandgun", "hudLoop", "getConfigName", "playerTags", "setName", "openSetName"];
